 ...
 * @since 1.00
 */
public class Message_new extends Resource {
     ...
     */
    public Message_new(final String message, final String errorCode, final String errorDetails) {
     ...
     *            the message.
     */
    public Message_new(final String message) {
        this.message = message;
        this.errorCode = null;
    ...
    public final void toJSON(final OutputStream out) throws IOException {
        ...
        if(errorCode != null) {
            jg.writeStringField("code", errorCode);
        }

        if(errorDetails != null) {
            jg.writeStringField("details", errorDetails);
        }
