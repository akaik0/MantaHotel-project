...
('A107', '1', '90.00', 'Double', 'A double room has one double bed for double occupancy.'),
('A146', '2', '96.00', 'Twin', 'A twin room has two single beds for double occupancy.'),
('A136', '1', '85.00', 'Double', 'A double room has one double bed for double occupancy.'),
('A120', '1', '70.00', 'Double', 'A double room has one double bed for double occupancy.'),
...
('A112', '1', '200.00', 'Suite', 'A suite room is comprised of more than 1 room.');
