    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException{
        ...
        switch (op){
            ...
            case "customer-list":{
                ...
                String dispatchPage = "/jsp/customer-bookings.jsp";
                ...
                if (personId == null) {
                    // when redirected from an insert booking if we are an hotel employee
                    dispatchPage = "/jsp/booking.jsp";
                }
        ...
        switch (op){
            ...
            case "add-customer": {
                ...
                if (personId == null || personId.equals("") || bookingId == null || bookingId.equals("")) {
                    ...
                    req.setAttribute("message", m);
                    req.getRequestDispatcher("/jsp/user-area/add-customer-booking.jsp").forward(req, res);
                } else {
