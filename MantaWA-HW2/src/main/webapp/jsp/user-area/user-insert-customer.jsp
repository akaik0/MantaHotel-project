...
<div id="header"><c:import url="/jsp/reusable/header.jsp"/></div>


<div class="container py-5 px-5 ">

<h1 class="text-xl p-2 border-bottom text-center">Register guest</h1>
    ...
    <c:when test="${empty customerList}">
        <form class="form-horizontal" method="POST" action="<c:url value="/booking/add-customer"/>">
            ...
            <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="data" class="form-control" id="Birthdate" placeholder="Enter Birthdate" name="Birthdate">
                            </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2" for="DocumentNumber">Document Number: </label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="DocumentNumber" placeholder="Enter Document Number" name="DocumentNumber">
                </div>
                <div class="col-sm-10">
    ...
    <c:otherwise>
        <h2 class="text-xl mt-4 py-3 text-center">List of guests registered to booking "${bookingId}"</h2>
            ...
            <div class="col-md-12 text-right">
                <a href="${pageContext.request.contextPath}/jsp/booking.jsp" class="hover:underline">< Back to Home page</a>
            </div>
            -->
</div>
-->
